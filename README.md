...
파트너 업체
  입점·계정 연결 -> 업체·옵션·전문가·미디어 관리 -> 신청·예약 대응

플랫폼 운영자
  업체 등록·검수 -> 담당자 지정 -> 계정 초대 -> 상태·정보 품질 관리
```
...
| 파트너 온보딩 | 구현 | 입점 임시저장·제출, 계정 초대·수락, 소유권 검증 |
...
| Partner | `/api/v1/partner` | 온보딩과 자기 업체 옵션·전문가 관리 |
