...
INSERT INTO staff_permissions (code, display_name) VALUES
    ...
    ('platform.hospital.show', '병원 조회'),
    ('platform.hospital.create', '병원 등록'),
    ('platform.hospital.update', '병원 수정'),
    ('platform.hospital.delete', '병원 삭제'),
    ('platform.hospital_entry.show', '입점신청 조회'),
    ('platform.hospital_entry.update', '입점신청 수정'),
    ...
    ('platform.doctor.show', '의료진 조회'),
    ('platform.doctor.create', '의료진 등록'),
    ('platform.doctor.update', '의료진 수정'),
    ('platform.doctor.delete', '의료진 삭제'),
    ...
    ('platform.hospital_event.show', '병원 이벤트 조회'),
    ('platform.hospital_event.create', '병원 이벤트 등록'),
    ('platform.hospital_event.update', '병원 이벤트 수정'),
    ('platform.hospital_event.delete', '병원 이벤트 삭제'),
    ('platform.hospital_event_ad.show', '병원 이벤트 광고 조회'),
    ('platform.hospital_event_ad.create', '병원 이벤트 광고 등록'),
    ('platform.hospital_event_ad.update', '병원 이벤트 광고 수정'),
    ('platform.hospital_event_ad.delete', '병원 이벤트 광고 삭제'),
    ('platform.hospital_event_db.show', '이벤트 상담 DB 조회'),
    ('platform.hospital_event_db.update', '이벤트 상담 DB 수정'),
    ('platform.hospital_event_real_model_db.show', '리얼모델 DB 조회'),
    ('platform.hospital_event_real_model_db.update', '리얼모델 DB 수정'),
    ('platform.hospital_review.show', '병원 후기 조회'),
    ('platform.hospital_review.update', '병원 후기 수정'),
    ('platform.hospital_evaluation.show', '병원 평가 조회'),
    ('platform.hospital_evaluation.update', '병원 평가 수정'),
    ('platform.reported_talk.show', '신고 토크 조회'),
    ('platform.reported_talk.update', '신고 토크 수정'),
    ('platform.reported_hospital_review.show', '신고 후기 조회'),
    ('platform.reported_hospital_review.update', '신고 후기 수정'),
    ('platform.reported_hospital_evaluation.show', '신고 평가 조회'),
    ('platform.reported_hospital_evaluation.update', '신고 평가 수정'),
...
WHERE r.name = 'platform.staff'
  AND p.code IN (
    ...
    'platform.hospital.update',
    'platform.hospital_entry.show',
    'platform.hospital_entry.update',
    'platform.user.show',
    'platform.doctor.show',
    'platform.video.show',
    'platform.hospital_event.show',
