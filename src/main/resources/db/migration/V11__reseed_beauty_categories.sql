-- 기존 뷰티 카테고리를 MVP용 K-뷰티 카테고리로 교체한다.
...
INSERT INTO beauty_category_seed (group_code, name, code, parent_code, depth, full_path, sort_order) VALUES
...
SELECT
    'BEAUTY', NULL, seed.depth, seed.group_code, seed.name, seed.code,
