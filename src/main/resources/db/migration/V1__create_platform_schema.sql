...
CREATE TABLE `partners` (
  ...
  `allow_status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE `partner_business_registrations` (
  ...
  KEY `partner_business_registrations_partner_id_index` (`partner_id`),
...
CREATE TABLE `partner_specialists` (
  ...
  `career_started_at` date DEFAULT NULL,
  `license_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '자격 증빙 번호',
  `specialist_field` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `educations` json DEFAULT NULL,
  `careers` json DEFAULT NULL,
  `etc_contents` json DEFAULT NULL,
  ...
  KEY `partner_specialists_specialist_field_index` (`specialist_field`),
  ...
  KEY `partner_specialists_deleted_specialist_id_idx` (`deleted_at`,`specialist_field`,`id`),
