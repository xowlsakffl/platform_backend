package com.platform.adapter.in.web.user.auth.controller;

import com.platform.adapter.in.web.user.auth.request.UserLoginRequest;
...
public class UserAuthController {
	...
	private static final AccountActorType ACTOR_TYPE = AccountActorType.USER;
	private final AuthWebService authWebService;

	public UserAuthController(AuthWebService authWebService) {
