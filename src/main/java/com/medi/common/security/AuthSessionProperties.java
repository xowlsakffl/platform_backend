...
public class AuthSessionProperties {
	...
	@Min(900)
	private long beautyTtlSeconds = 43_200;

	@Min(900)
	private long beautyPersistentTtlSeconds = 2_592_000;
	...
	public long ttlSeconds(AccountActorType actorType, boolean persistent) {
		return switch (actorType) {
			...
			case BEAUTY -> persistent ? beautyPersistentTtlSeconds : beautyTtlSeconds;
	...
	public long getBeautyTtlSeconds() {
		return beautyTtlSeconds;
	}

	public void setBeautyTtlSeconds(long value) {
		beautyTtlSeconds = value;
	}

	public long getBeautyPersistentTtlSeconds() {
		return beautyPersistentTtlSeconds;
	}

	public void setBeautyPersistentTtlSeconds(long value) {
		beautyPersistentTtlSeconds = value;
	}
