...
public record DoctorUpdateForHospitalRequest(
	...
	@BindParam("specialist_field") DoctorSpecialistField specialistField,
	DoctorStatus status,
	...
	public UpdateDoctorForHospitalCommand toCommand(Set<String> requestFields) {
		Set<String> fields = normalizeFields(requestFields);
		return new UpdateDoctorForHospitalCommand(
			sortOrder,
			name,
			gender,
			position,
