package com.medi.adapter.in.web.partner.auth.controller;

import com.medi.adapter.in.web.partner.auth.request.PartnerLoginRequest;
...
public class PartnerAuthController {
	...
	public ApiResponse login(
		@Valid @RequestBody PartnerLoginRequest body,
