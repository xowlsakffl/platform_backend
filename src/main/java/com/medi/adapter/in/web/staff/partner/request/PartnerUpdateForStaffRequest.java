...
public record PartnerUpdateForStaffRequest(
	...
	@BindParam("instagram_link") @Size(max = 500) String instagramLink,
	@BindParam("kakao_link") @Size(max = 500) String kakaoLink,
	...
	@BindParam("category_ids[]") @Size(min = 1) Set<@Positive Long> categoryIds,
	...
	public UpdatePartnerCommand toCommand(Set<String> requestFields) {
		...
		return new UpdatePartnerCommand(
			...
			fields.contains("category_ids") ? PartnerRequestSupport.ids(categoryIds) : null,
