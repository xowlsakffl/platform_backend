...
import com.medi.adapter.in.web.staff.doctor.request.DoctorCreateForStaffRequest;
import com.medi.adapter.in.web.staff.doctor.request.DoctorListForStaffRequest;
import com.medi.adapter.in.web.staff.doctor.request.DoctorStatusUpdateForStaffRequest;
import com.medi.adapter.in.web.staff.doctor.request.DoctorUpdateForStaffRequest;
import com.medi.adapter.in.web.staff.doctor.request.HospitalOptionListForStaffRequest;
import com.medi.application.doctor.DoctorForStaffService;
...
public class DoctorForStaffController {

	private final DoctorForStaffService service;

	public DoctorForStaffController(DoctorForStaffService service) {
	...
	public ApiResponse list(
		...
		@Valid @ModelAttribute DoctorListForStaffRequest query,
	...
	public ApiResponse hospitalOptions(
		@AuthenticationPrincipal AuthenticatedActor actor,
		@Valid @ModelAttribute HospitalOptionListForStaffRequest query,
		HttpServletRequest request
	) {
	...
	public ApiResponse create(
		@AuthenticationPrincipal AuthenticatedActor actor,
		@Valid @ModelAttribute DoctorCreateForStaffRequest body,
		HttpServletRequest request
	) {
	...
	public ApiResponse update(
		@AuthenticationPrincipal AuthenticatedActor actor,
		@PathVariable Long id,
		@Valid @ModelAttribute DoctorUpdateForStaffRequest body,
		HttpServletRequest request
	) {
		return ApiResponse.success(
	...
	public ApiResponse patch(
		@AuthenticationPrincipal AuthenticatedActor actor,
		@PathVariable Long id,
		@Valid @RequestBody DoctorStatusUpdateForStaffRequest body,
		HttpServletRequest request
	) {
