...
@Entity
@Table(name = "hospital_business_registrations")
public class HospitalBusinessRegistration extends BaseTimeEntity {
	...
	private HospitalBusinessRegistrationStatus status = HospitalBusinessRegistrationStatus.ACTIVE;

	protected HospitalBusinessRegistration() {
	}

	public HospitalBusinessRegistration(
	...
	public HospitalBusinessRegistrationStatus status() {
		return status;
	}
}
